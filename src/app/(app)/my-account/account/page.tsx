  ...
  return (
    <div className="mx-auto max-w-md space-y-6">
      ...
      <div className="rounded-xl border bg-white p-6 shadow-sm space-y-4">
        <div>
          <div className="text-xs text-gray-400 uppercase tracking-wide font-medium mb-1">Logged in as</div>
        ...
        {success && (
          <p className="rounded-lg bg-green-50 px-3 py-2 text-sm text-green-700">Password updated successfully.</p>
        )}
        {error && (
          <p className="rounded-lg bg-red-50 px-3 py-2 text-sm text-red-700">{ERROR[error] ?? "Something went wrong."}</p>
        )}
